 ...
 */
@Config
public class SampleMecanumDriveAuto extends MecanumDrive {


    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(12, 0.05, 0.2); // changed
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(10.5/*changed from 10*/, 0.05/*was 0.5*/, 0.1); // changed
    ...
    public SampleMecanumDriveAuto(HardwareMap hardwareMap)
    {
        this(hardwareMap,false);
    }
    public SampleMecanumDriveAuto(HardwareMap hardwareMap, boolean qAdj) {
