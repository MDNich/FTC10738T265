 ...
 */
@Config
public class StandardTrackingWheelLocalizerCam extends TwoTrackingWheelLocalizer {
    ...
    public StandardTrackingWheelLocalizerCam(HardwareMap hardwareMap, boolean qAdj, T265Camera intelCam) {
        super(Arrays.asList(
    ...
    public double getHeading() {
        return intelCam.getLastReceivedCameraUpdate().pose.getHeading();
    }
}
