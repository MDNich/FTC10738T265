...
public class RRDriveControllerNoOdom extends RobotSubsytemManager {
    public SampleMecanumDriveNoOdom drive;
    Telemetry telemetry;
    HardwareMap hwMap;


    public RRDriveControllerNoOdom(HardwareMap hwMap, Telemetry telemetry)
    {
        super(hwMap,telemetry);
        drive = new SampleMecanumDriveNoOdom(hwMap,false);
