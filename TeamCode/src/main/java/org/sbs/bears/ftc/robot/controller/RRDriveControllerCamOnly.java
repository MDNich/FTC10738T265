...
public class RRDriveControllerCamOnly extends RobotSubsytemManager {
    public SampleMecanumDriveOnlyCam drive;
    Telemetry telemetry;
    HardwareMap hwMap;


    public RRDriveControllerCamOnly(HardwareMap hwMap, Telemetry telemetry, T265Camera intelCam)
    {
        super(hwMap,telemetry);
        drive = new SampleMecanumDriveOnlyCam(hwMap,false, intelCam);
