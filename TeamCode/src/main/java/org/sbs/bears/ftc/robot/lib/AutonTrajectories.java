...
public class AutonTrajectories {
    ...
    public static Pose2d secondWobblePosition = new Pose2d(-35.8, -39, 3.08);
    ...
    // Four Rings
    public static Pose2d fourRingPrepPosition = new Pose2d(-37,-34.2, 6.26);
    public static Pose2d fourRingWobbleDropPosition = new Pose2d(46, -64, 0);
    public static Pose2d fourRingSecondWobbleDropPosition = new Pose2d(38.98, -60, 5.4);
    ...
    public static void initialize(SampleMecanumDrive drive) {
        ...
        fourRingFirstHitTrajectory = drive.trajectoryBuilder(fourRingPrepStackTrajectory.end())
                .forward(13, velConstraint, new ProfileAccelerationConstraint(50))
                .build();
        ...
        fourRingWobbleOneTrajectory = drive.trajectoryBuilder(fourRingSecondHitTrajectory.end())
                .lineToSplineHeading(fourRingWobbleDropPosition)
                .build();
        ...
        fourRingGoEndTrajectory = drive.trajectoryBuilder(fourRingWobbleTwoDropOffTrajectory.end())
                .lineToSplineHeading(endPosition)
                .build();
